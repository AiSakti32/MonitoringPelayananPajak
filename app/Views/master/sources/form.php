...
$action = $mode === 'create' ? url('/master/sources') : url('/master/sources/' . ($item['id'] ?? '') . '/update');
?>
<div class="form-page">
    <a href="<?= e(url('/master/sources')) ?>" class="back-link"><i class="bi bi-arrow-left"></i> Kembali</a>
    <div class="panel-card form-card mt-3">
        ...
        <form method="post" action="<?= e($action) ?>" class="master-form" data-loading-form>
            ...
            <div class="row g-3">
                <div class="col-md-8">
                    <label class="form-label" for="name">Nama Sumber <span class="text-danger">*</span></label>
            ...
            <div class="form-actions mt-4">
                ...
                <a href="<?= e(url('/master/sources')) ?>" class="btn btn-outline-secondary">Batal</a>
            </div>
        </form>
    </div>
</div>
